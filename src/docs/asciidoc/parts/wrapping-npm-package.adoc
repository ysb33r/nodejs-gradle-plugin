...
In some cases you might want to also add a task type, similar to `GulpTask`. One approach is to extend link:{api}/org/ysb33r/gradlenodejs/tasks/AbstractNodeBaseTask.html[AbstractNodeBaseTask].
