...
A collection of Gradle plugins to deal with the Node.js development environment in a very gradlesque way.
...
* https://github.com/ysb33r/nodejs-gradle-plugin[Fork me on Github]
